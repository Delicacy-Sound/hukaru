...
module.exports = class ReportBugCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
        Sends a message to the Hikaru Support Server's bug report channel.
  ...
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [Calypso Support Server](https://discord.gg/weayRSckT3) to further discuss your issue.
        Additionally, feel free to submit an issue on [GitHub](https://github.com/Delicacy-Sound/hukaru/issues).
      `) 
