...
module.exports = class SupportServerCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['support', 'ss'],
      usage: 'supportserver',
      description: 'Displays the invite link to Hikaru\'s Discord Support Server.',
  ...
  run(message) {
    const embed = new MessageEmbed()
      ...
      .setDescription('Click [here](https://discord.gg/weayRSckT3) to join the Hikaru Support Server!')
