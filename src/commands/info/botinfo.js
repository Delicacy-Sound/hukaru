...
module.exports = class BotInfoCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['bot', 'bi'],
      usage: 'botinfo',
      description: 'Fetches Hikaro\'s bot information.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('Hikaro\'s Bot Information')
      .setDescription(oneLine`
        Hikaro is an open source, fully customizable Discord bot that is constantly growing.
      ...
      .addField(
        ...
        '[Repository](https://github.com/sabattle/HikaroBot)**'
      )
      .setImage('https://media.discordapp.net/attachments/897221331433705502/921500795269181560/PicsArt_12-17-01.17.08.jpg?width=819&height=461')
